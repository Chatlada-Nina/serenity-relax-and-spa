...
### Typography
I wanted to keep my website simple and clean so I used 2 different font styles. My spa name used Italiano I wanted to keep my website simple and clean so I used 2 different font styles. My spa's name used [Italiano](https://fonts.google.com/specimen/italiano) because It looks elegant and It is a hand-writing font style which makes it perfect for my page’s name and the rest of the text I used [Lexend](https://fonts.google.com/specimen/Lexend) because It intends to reduce visual stress and improve reading performance for the users. 
